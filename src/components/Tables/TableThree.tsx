                    ...
                    {loading ? (<Loader />) : (
                        <>
                            <table className="w-full table-auto my-1">
                                ...
                                <tbody>
                                    {geodatas?.data.map((item: any, key) => (
                                        <tr key={key}>
                                            ...
                                            <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                                <p className="text-black dark:text-white">
                                                    {item.bukan_kawasan_hutan}
                                                </p>
                                            </td>
                                            <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                                <p className="text-black dark:text-white">
                                                    {item.total_deforestasi}
                                                </p>
                                            </td>
                                            <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                                <div className="flex items-center space-x-3.5">
                                                    ...
                                                    <Link href={"/tables/edit?id=" + item.id} className="hover:text-primary">
                                                        <svg
                                                            className="fill-current"
                                                            width="18"
                                                            height="18"
                                                    ...
                                                    <button onClick={(e: any) => (geodataDelete(item.id))} className="hover:text-primary">
                                                        <svg
                                                            className="fill-current"
                                                            width="18"
                                                            height="18"
