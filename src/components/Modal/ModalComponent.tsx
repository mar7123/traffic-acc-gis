...
const ModalComponent = ({
    ...
    return (
        <Modal show={optModal.open} size="md" onClose={() => setModal({ ...optModal, open: false })} className="z-9999" theme={{ root: { base: "fixed top-0 right-0 left-0 z-50 h-modal h-screen px-4 overflow-y-auto overflow-x-hidden md:inset-0 md:h-full" }, content: { base: "relative h-fit w-full md:h-auto" } }} dismissible>
            <Modal.Header theme={{base: "flex items-start justify-between rounded-t"}} />
            <Modal.Body >
