                        ...
                        <div className="overflow-x-auto my-2">
                            ...
                            <Table striped>
                                <Table.Head >
                                    ...
                                    <Table.HeadCell className="bg-black text-white dark:bg-white dark:text-black">Waktu Laporan Dibuat</Table.HeadCell>
                                ...
                                <Table.Body className="divide-y">
                                    {reports.data?.map((item: ReportsMod, key: number) => (
                                        <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800" key={key}>
                                            ...
                                            <Table.Cell className="max-w-[100px] text-clip overflow-hidden">{item.latitude}</Table.Cell>
                                            <Table.Cell className="max-w-[100px] text-clip overflow-hidden">{item.longitude}</Table.Cell>
