        ...
        <>
            <div className={'min-h-fit flex items-center my-2'}>
                <Navbar className="w-full bg-transparent max-w-screen-2xl px-[4vw] sm:px-[4vw] lg:px-[7vw] text-white mx-auto" fluid rounded>
                    <Navbar.Brand href="/">
                        ...
                        <span className="ml-2 self-center whitespace-nowrap text-md sm:text-2xl font-semibold dark:text-white">TARGIS</span>
                    </Navbar.Brand>
            ...
            {pathname == "/" ? (
                <div className='h-[92vh] px-[4vw] sm:px-[4vw] md:px-[7vw] sm:max-w-screen-2xl grid grid-cols-1 lg:grid-cols-2 gap-0 content-center mx-auto'>
                    <div className='p-12'>
                        <h1 className="text-2xl sm:text-4xl xl:text-6xl font-bold text-white mb-4">Traffic Accident Risk Analysis</h1>
                        <p className="text-md sm:text-lg md:text-xl text-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut </p>
