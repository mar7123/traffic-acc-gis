        ...
        <>
            <div className={'min-h-fit flex items-center my-1'}>
                <Navbar className="w-full bg-transparent max-w-screen-2xl px-[4vw] sm:px-[4vw] lg:px-[7vw] text-white mx-auto" fluid rounded>
                    ...
                    <Navbar.Collapse theme={{list:"mt-4 py-4 flex flex-col absolute top-[60px] left-0 bg-black w-screen md:w-fit md:static md:mt-0 md:py-0 md:flex-row md:space-x-8 md:text-sm md:font-medium"}}>
