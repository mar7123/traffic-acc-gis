                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 h-full content-center">
                    <div className="hidden w-full xl:flex xl:flex-col xl:items-center justify-self-center xl:py-15 sm:py-5 lg:px-[10%] sm:px-[5%]">
                        <Link className="mb-5.5 inline-block" href="/">
                            <svg width="300px" height="300px" viewBox="0 0 24 24" fill="white" stroke='black' xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="justify-self-center w-full xl:py-15 sm:py-5 lg:px-[10%] sm:px-[5%]">
                        <form className="flex w-full flex-col gap-4" action={loginFormAction}>
                            ...
                            <Button className="bg-black hover:bg-opacity-80" type="submit">
